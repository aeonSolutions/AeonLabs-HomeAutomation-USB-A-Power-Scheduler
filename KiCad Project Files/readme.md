 [Distributed Power Storage](https://github.com/aeonSolutions/AeonLabs-HomeAutomation-Distributed-power_storage/tree/main)  >>   USB-A Power Scheduler
...
This folder contains the KiCad Project files, for the hardware electronics of the USB-A Smart Scheduler.  Each KiCad project is available with a [creative commons share alike non-commercial license](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en). 

<p align="center">
  <strong> <a href="https://aeonsolutions.github.io/portfolio/usb_power_schedule/">Interactive web view of the PCB Layout</a> </strong> <br>
